      ...
      setState(() {
        for (int i = 0; i < 4; i++) {
          ...
          if (entries != null && entries.isNotEmpty) {
            ...
            final freq = {5: 0, 10: 0, 15: 0, 25: 0, 50: 0, 100: 0, 150: 0, 200: 0, 250: 0};
            for (var s in scores) {
  ...
  void _resetPlayerStats(int index) {
    ...
    setState(() {
      _playerStats[index] = {
        ...
        'games': 0,
        'group': '-',
        'frequencies': {5: 0, 10: 0, 15: 0, 25: 0, 50: 0, 100: 0, 150: 0, 200: 0, 250: 0},
        'history': <Map<String, dynamic>>[],
      };
    });
    ...
    updatedFreqs[index] = {5: 0, 10: 0, 15: 0, 25: 0, 50: 0, 100: 0, 150: 0, 200: 0, 250: 0};
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ...[5, 10, 15, 25, 50, 100, 150, 200, 250].map((pt) => Text(
