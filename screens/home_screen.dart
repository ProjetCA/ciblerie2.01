...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  // Variables pour stocker les données du gagnant
  String winnerPseudo = 'Joueur1';  // Exemple de pseudo, à remplacer par ta logique de calcul
  int winnerScore = 100;            // Exemple de score, à remplacer par ta logique de calcul
  ...
  Widget build(BuildContext context) {
    ...
    // Déterminer les icônes et couleurs en fonction du statut WebSocket
    Color wifiColor;
    IconData wifiIcon;
    String wifiLabel;
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildLargeButton(
                            ...
                            onTap: () {
                              // Redirection vers ClassementGeneralScreen avec les données du gagnant
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => ClassementGeneralScreen(
                                    winnerPseudo: winnerPseudo,  // Passer le pseudo du gagnant
                                    winnerScore: winnerScore,    // Passer le score du gagnant
                                  ),
                                ),
                              );
                            },
