...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  // Variables pour stocker les données du gagnant (initialisées à null)
  String? winnerPseudo;
  int? winnerScore;
                      ...
                      child: Row(
                        children: [
                          ...
                          _buildLargeButton(
                            ...
                            onTap: () {
                              // Vérifie si les données du gagnant sont disponibles avant la redirection
                              if (winnerPseudo != null && winnerScore != null) {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('Aucun gagnant défini.'),
                                  ),
                                );
                              }
                            },
